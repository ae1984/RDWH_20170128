create or replace force view u1.v_sco_mo_test_tmp_7_1 as
select to_date(t.s_date||t.s_time,'yymmddhh24miss') as s_date,
       ...
       t.result, t.status
from SCO_MO_TEST_TMP_7_1 t
;
grant select on U1.V_SCO_MO_TEST_TMP_7_1 to LOADDB;
grant select on U1.V_SCO_MO_TEST_TMP_7_1 to LOADER;
