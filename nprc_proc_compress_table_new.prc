create or replace procedure u1.NPRC_PROC_COMPRESS_TABLE_NEW is
begin
    insert into NT_PROCESS_COMPRESS_TABLE
    ...
    where /*t.table_name='T_RBO_PORT' and */ t.partitioned <> 'YES' and t.compression = 'DISABLED'
         /*and (a.bytes/(1024 * 1024))>500 and l.object_name is null and mv.mview_name is null*/;
    commit;
end NPRC_PROC_COMPRESS_TABLE_NEW;
/
