create or replace procedure u1.ETLT_DWH_PORT_AUTO_TST is
      s_mview_name         varchar2(30) := 'T_DWH_PORT_AUTO_TST';
    ...
    begin
     ...
     for cur in (select d_max_date + level as rep_date
       ...
       insert /*+  append */ into T_DWH_PORT_AUTO_TST(rep_date,deal_number,prod_type,total_debt,delinq_days,delinq_days_old,discount,eff_rate,reduced_cost,market_cost,total_ts_cost,total_set_cost,zalog_cost,is_on_balance,IS_GU_SALE,SALE_AMOUNT,SALE_DATE,ZALOG_CONTRACT_NUMBER)
