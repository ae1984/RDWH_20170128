create or replace force view u1.v_cancel_one_year_test as
select /*+ first_rows */
  c.id as cancel_id,
...
;
grant select on U1.V_CANCEL_ONE_YEAR_TEST to LOADDB;
grant select on U1.V_CANCEL_ONE_YEAR_TEST to LOADER;
