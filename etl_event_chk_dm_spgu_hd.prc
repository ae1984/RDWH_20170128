create or replace procedure u1.ETL_EVENT_CHK_DM_SPGU_HD is
   v_event varchar2(50) := 'ETL_EVENT_CHK_DM_SPGU_HD';
...
begin
  ...
  where t.obj_name='V_DWH_PORT_CREDITS' and t.numrows>0 and t.dt >= trunc(sysdate)-14;
