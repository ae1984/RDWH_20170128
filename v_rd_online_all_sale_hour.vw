create or replace force view u1.v_rd_online_all_sale_hour as
  ...
  from (select y.text_hh_mi, y.fld_cnt, y.x_dnp_region
          from (select /*tm.yyyy_mm_dd,*/
                 ...
                 f.x_dnp_region
                  ...
                  left join m_rfo_online_fld_ekt_new /*_day*/
                f
...
;
grant select on U1.V_RD_ONLINE_ALL_SALE_HOUR to LOADDB;
