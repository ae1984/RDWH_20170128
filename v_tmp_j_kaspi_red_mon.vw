create or replace force view u1.v_tmp_j_kaspi_red_mon as
...
from U1.M_TMP_J_KASPI_RED_MON_1 m1
...
left join u1.M_TMP_J_KASPI_RED_MON_2 m2 on m2.folder_id = m1.fld_id
left join u1.M_TMP_J_KASPI_RED_MON_4 m4 on m4.folder_id = m1.fld_id
order by 2 desc
;
grant select on U1.V_TMP_J_KASPI_RED_MON to LOADDB;
