create or replace force view u1.v_dwh_port_cards_credits as
select
...
from V_DWH_PORT_CREDITS
;
grant select on U1.V_DWH_PORT_CARDS_CREDITS to DTS_USER;
grant select on U1.V_DWH_PORT_CARDS_CREDITS to FINAN;
grant select on U1.V_DWH_PORT_CARDS_CREDITS to LOADDB;
grant select on U1.V_DWH_PORT_CARDS_CREDITS to LOADER;
