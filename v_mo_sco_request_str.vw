create or replace force view u1.v_mo_sco_request_str as
...
;
grant select on U1.V_MO_SCO_REQUEST_STR to LOADDB;
grant select on U1.V_MO_SCO_REQUEST_STR to LOADER;
