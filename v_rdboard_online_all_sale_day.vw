create or replace force view u1.v_rdboard_online_all_sale_day as
...
;
grant select on U1.V_RDBOARD_ONLINE_ALL_SALE_DAY to LOADDB;
grant select on U1.V_RDBOARD_ONLINE_ALL_SALE_DAY to LOADER;
grant select on U1.V_RDBOARD_ONLINE_ALL_SALE_DAY to LOAD_RDWH_PROD;
