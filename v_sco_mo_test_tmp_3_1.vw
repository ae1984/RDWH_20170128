create or replace force view u1.v_sco_mo_test_tmp_3_1 as
...
from SCO_MO_TEST_TMP_3_1 t;
grant select on U1.V_SCO_MO_TEST_TMP_3_1 to LOADDB;
grant select on U1.V_SCO_MO_TEST_TMP_3_1 to LOADER;
