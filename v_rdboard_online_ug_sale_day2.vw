create or replace force view u1.v_rdboard_online_ug_sale_day2 as
...
;
grant select on U1.V_RDBOARD_ONLINE_UG_SALE_DAY2 to LOADDB;
grant select on U1.V_RDBOARD_ONLINE_UG_SALE_DAY2 to LOADER;
grant select on U1.V_RDBOARD_ONLINE_UG_SALE_DAY2 to LOAD_RDWH_PROD;
