create or replace force view u1.v_rdboard_online_city_sale_d2 as
...
;
grant select on U1.V_RDBOARD_ONLINE_CITY_SALE_D2 to LOADDB;
grant select on U1.V_RDBOARD_ONLINE_CITY_SALE_D2 to LOADER;
grant select on U1.V_RDBOARD_ONLINE_CITY_SALE_D2 to LOAD_RDWH_PROD;
