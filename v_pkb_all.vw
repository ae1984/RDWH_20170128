create or replace force view u1.v_pkb_all as
select /*+first_rows*/
    p.id as report_id,
...
;
grant select on U1.V_PKB_ALL to LOADDB;
grant select on U1.V_PKB_ALL to LOADER;
grant select on U1.V_PKB_ALL to RISK_VERIF;
