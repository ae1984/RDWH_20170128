create or replace force view u1.v_rd_online_cen_appr_day_new as
            ...
            ---
                  ...
                  from (select /*tm.yyyy_mm_dd,*/
                        ...
                        --   and  trunc(f.folder_date_create_mi) =to_date('20.01.2014','DD.MM.YYYY')
                         ...
                         group by  tm.text_hh) x
                 group by x.text_hh) y) z
;
grant select on U1.V_RD_ONLINE_CEN_APPR_DAY_NEW to LOADDB;
