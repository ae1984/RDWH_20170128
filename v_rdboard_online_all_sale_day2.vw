create or replace force view u1.v_rdboard_online_all_sale_day2 as
select /*+parallel(5)*/ "TEXT_YYYY_MM_DD_HH_10MI", fld_cnt_avg
  from (select y.text_yyyy_mm_dd_hh_10mi, y.fld_cnt_avg
...
;
grant select on U1.V_RDBOARD_ONLINE_ALL_SALE_DAY2 to LOADDB;
grant select on U1.V_RDBOARD_ONLINE_ALL_SALE_DAY2 to LOADER;
grant select on U1.V_RDBOARD_ONLINE_ALL_SALE_DAY2 to LOAD_RDWH_PROD;
