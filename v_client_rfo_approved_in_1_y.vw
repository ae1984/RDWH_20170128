create or replace force view u1.v_client_rfo_approved_in_1_y as
...
join v_folder_all_rfo f on (f.credit_contract_id  = c.rfo_contract_id or
                            ...
                            f.folder_date_create > trunc(sysdate) - 365
...
;
grant select on U1.V_CLIENT_RFO_APPROVED_IN_1_Y to LOADDB;
grant select on U1.V_CLIENT_RFO_APPROVED_IN_1_Y to LOADER;
