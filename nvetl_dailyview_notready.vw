create or replace force view u1.nvetl_dailyview_notready as
select b.object_name, b.reference_from_event, min(b.priority) as priority , b.check_proc--,l.object_name
      ...
      join all_objects o on o.owner='U1' and o.object_name =b.object_name and o.object_type='VIEW'
      ...
      where b.is_used=1 and b.type_load in ('DAILY','ONLINE') and l.object_name is null
           and b.check_proc is not null
