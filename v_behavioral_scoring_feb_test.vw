create or replace force view u1.v_behavioral_scoring_feb_test as
...
;
grant select on U1.V_BEHAVIORAL_SCORING_FEB_TEST to LOADDB;
grant select on U1.V_BEHAVIORAL_SCORING_FEB_TEST to LOADER;
