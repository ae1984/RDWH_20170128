create or replace force view u1.v_behavioral_scoring_1 as
...
from V_BEHAVIORAL_SCORING_1_OLD t
join V_BEHAVIORAL_SCORING_3 t3 on t3.rfo_client_id = t.rfo_client_id;
grant select on U1.V_BEHAVIORAL_SCORING_1 to LOADDB;
grant select on U1.V_BEHAVIORAL_SCORING_1 to LOADER;
