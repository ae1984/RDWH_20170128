create or replace force view u1.v_pkb_report_con_decr_13 as
with p as (
...
;
grant select on U1.V_PKB_REPORT_CON_DECR_13 to LOADDB;
grant select on U1.V_PKB_REPORT_CON_DECR_13 to LOADER;
