create or replace procedure u1.etleml_cpr
as
    EMAIL_CODE varchar2(32) := 'FOLDER_CPR';
  ...
  begin
    ...
    v_error_count := 0;
    v_subject := 'Папки на проверке ЦПР';
    ...
    loop
      ...
      insert into u1.t_folder_cpr_sended (folder_id, date_create)
    ...
    if (v_error_count > 0) then
      ...
      delete from u1.t_folder_cpr_sended;
    end if;
