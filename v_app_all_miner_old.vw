create or replace force view u1.v_app_all_miner_old as
select /*+ parallel(10) */
  am.app_id,
...
/*  rbo_d.balance_all_dep_beg_x,
  ...
  --
  /*prm.operator_value,
  prm.unique_sumbol_qty,
  prm.unique_contact_persons,
  prm.unique_subs_on_a_number,
  prm.unique_kaspikz_client,
  prm.application_flag,
  prm.count_application,
  prm.subs_with_delay_in_contact,
  prm.delay_contacts_share,
  prm.pmt_qty,
  prm.share_of_kaspikz_pmt,
  prm.ttl_pmt_amt,
  prm.avg_pmt,
  prm.days_from_first_mob_pay,
  prm.unique_terminal_qty,
  ...
  prm.years_from_issue_ever,
  prm.actual_auto_flag,
  prm.years_from_issue,
...
left join RISK_AKNAZAR.M_APP_FRAUD_CARDS crd on crd.app_id = am.app_id
